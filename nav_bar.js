...
window.onscroll = function () {
    ...
    if (window.pageYOffset > headerSection.offsetHeight - 75) {
        ...
        logoImage.src = "images/logo-apricaphotography-pro-photographer-Thurston-county.png";
    } else {
        nav.classList.remove("active");
        logoImage.src = "images/logo-apricaphotography-pro-photographer-greater-Seattle-area.png";
    }
